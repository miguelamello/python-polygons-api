env = {
  ...
  #'mongo_host': 'mongodb://localhost:27017/polygon?retryWrites=false&directConnection=true', 
  ...
  'redis_host': 'cluster1-orionsotf-0001-001.ukaiu6.0001.sae1.cache.amazonaws.com',
  'redis_ttl': 3600,
}
