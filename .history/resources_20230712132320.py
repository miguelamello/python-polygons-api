...
class ProviderResource(Resource):
    ...
    def post(self):
        ...
        if data.get('name'):
            data['name'] = 
            data.set('name', data.get('name').title())
            name = data.get('name')

        if data.get('email'):
            data.set('email', data.get('email').lower())
            email = data.get('email')
        
        if data.get('phone'):
            data.set('phone', Utils.toNumber(data.get('phone')))
            phone = data.get('phone')
        
        if data.get('language'):
            data.set('language', data.get('language').title())
        
        if data.get('currency'):
            data.set('currency', data.get('currency').upper())
