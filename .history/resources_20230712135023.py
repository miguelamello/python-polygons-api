...
class ProviderResource(Resource):
    ...
    def post(self):
        ...
        # Verify required fields. Exit if any of the required fields are missing
        ...
        # Verify if provider entries already exists. Exit if any of the entries already exists
